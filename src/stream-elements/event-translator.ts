...
import { type AonyxBuddyStreamEvent, type ChatMessage, AonyxBuddyStreamEventTypes, AonyxBuddyTypescriptIDS } from "@aonyxbuddy/stream-events";

import * as SETypes from './types.js';

export default function TranslateStreamElementsEventToAonyxEvent(_event: any): AonyxBuddyStreamEvent | undefined {
    function messageFromString(_message: string): ChatMessage {
        return {
            text: _message ?? '',
            emotes: []
        }
    ...
    function translateMessage(_event: any): AonyxBuddyStreamEvent {
        const seMessage: SETypes.SEMessageEvent = _event;
        const aonyxMessage: AonyxBuddyStreamEvent = {
            tstype: AonyxBuddyTypescriptIDS.STREAM_EVENT,
            type: AonyxBuddyStreamEventTypes.CHAT,
    ...
    function translateOther(_event: any): AonyxBuddyStreamEvent | undefined {
        //Gift Parsing
        ...
        let aonyxEvent: AonyxBuddyStreamEvent;
        const base : {tstype: AonyxBuddyTypescriptIDS.STREAM_EVENT, username:string} = {
            tstype: AonyxBuddyTypescriptIDS.STREAM_EVENT,
        ...
        switch (seEvent.type) {
            case 'follower':
                aonyxEvent = {
                    ...base,
                    type: AonyxBuddyStreamEventTypes.FOLLOW
                };
                break;
            case 'subscriber':
                aonyxEvent = {
                    ...base,
                    type: AonyxBuddyStreamEventTypes.SUBSCRIBER,
            ...
            case 'gift':
                if (+seEvent.bulkGifted > 0) {
                    ...
                    aonyxEvent = {
                        ...
                        type: AonyxBuddyStreamEventTypes.GIFT_BULK_SENT,
                    ...
                    aonyxEvent = {
                        ...base,
                        username: seEvent.sender,
                        type: AonyxBuddyStreamEventTypes.GIFT_BULK_RECEIVED,
                    ...
                    aonyxEvent = {
                        ...base,
                        username: seEvent.sender,
                        type: AonyxBuddyStreamEventTypes.GIFT_SINGLE,
                        gift_receiver: seEvent.name,
                    }
                }
                break;
            case 'raid':
                aonyxEvent = {
                    ...base,
                    type: AonyxBuddyStreamEventTypes.RAID,
            ...
            case 'cheer':
                aonyxEvent = {
                    ...base,
                    type: AonyxBuddyStreamEventTypes.CHEER,
